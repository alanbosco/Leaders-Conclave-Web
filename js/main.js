...
jQuery(document).on('ready', function() {
	...
	/* -------------------------------------
			NEXT EVENT COUNTER
	-------------------------------------- */
	jQuery('#tg-upcomingeventcounter').countdown('2017/10/23', function(event) {
	...
	/* -------------------------------------
			NEXT EVENT COUNTER
	-------------------------------------- */
	jQuery('#tg-upcomingeventcountervtwo').countdown('2017/10/23', function(event) {
		var $this = jQuery(this).html(event.strftime(''
	...
	jQuery("#tg-locationmap").gmap3({
		marker: {
			address: "ILAHIA COLLEGE OF ENGINEERING AND TECHNOLOGY, Mulavoor, Kerala",
			options: {
				title: "Leaders Conclave",
